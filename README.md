...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=2563EB&center=true&vCenter=true&width=1000&lines=Estudante+de+Engenharia+da+Computa%C3%A7%C3%A3o+na+UFAM;T%C3%A9cnica+em+Programa%C3%A7%C3%A3o+de+Jogos+Digitais+no+IFAM;Desenvolvedora+Full-Stack+em+forma%C3%A7%C3%A3o;Tecnologia%2C+inova%C3%A7%C3%A3o+e+solu%C3%A7%C3%B5es+digitais" alt="Typing SVG" />

### Engenharia da Computação • Android • Web • Front-end • Full-Stack • Inovação
...
Sou estudante de **Engenharia da Computação na Universidade Federal do Amazonas (UFAM)**, com formação técnica em **Programação de Jogos Digitais pelo Instituto Federal do Amazonas (IFAM)** e experiência no desenvolvimento de projetos **Android e Web**.

Tenho grande interesse em **tecnologia, inovação e desenvolvimento de soluções digitais**, com participação em **projetos acadêmicos, iniciação científica, extensão, eventos tecnológicos** e experiências de **liderança em equipes**.

Minha trajetória combina **criatividade, desenvolvimento de software e resolução de problemas**, buscando transformar ideias em soluções úteis, funcionais e bem estruturadas, com atenção à organização, agilidade no desenvolvimento e qualidade na entrega.

---

## Destaques da trajetória

* **1º lugar — Melhor Pitch**, pelo projeto **Programa AI**, na **Samsung Ocean (2023)**
* Participação e apresentação de projetos em **PIBIC, PIBEX e INOVATECH (2021–2023)**
* **Liderança em projetos de robótica**, com atuação na **FIRST LEGO League (2020–2022)**
* Participação em **palestras e apresentações de tecnologia** no **IFAM (2020–2022)**
...
`Desenvolvimento Android` • `Desenvolvimento Web` • `Full-Stack` • `Engenharia de Software` • `Banco de Dados` • `Educação e Tecnologia` • `Front-end` • `Back-end`
...
Busco ampliar minha experiência como desenvolvedora por meio de projetos que envolvam **tecnologia, inovação e impacto prático**, aprofundando meus conhecimentos em desenvolvimento de software e participando da criação de soluções que resolvam problemas reais.
